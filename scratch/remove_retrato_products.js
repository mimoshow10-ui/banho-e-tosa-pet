...
async function main() {
  console.log('--- Searching for products containing "retrato" ---');
  ...
  console.log(`Found ${prods.length} products with "retrato" in name:`);
  prods.forEach(p => {
  ...
  if (prods.length > 0) {
    ...
    if (delErr) {
      ...
      console.log(`✅ Successfully deleted ${ids.length} products containing "retrato"!`);
    }
  } else {
    console.log('No products found matching "retrato".');
  }
}
